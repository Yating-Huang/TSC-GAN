...
from utils import set_lr, get_lr, generate_noise, plot_multiple_images, save_fig, save, lab_to_rgb, \
    get_sample_images_list1
from losses.losses import SGAN, LSGAN, HINGEGAN, WGAN, RASGAN, RALSGAN, RAHINGEGAN, QPGAN


class T1():
    def __init__(self, loss_type, netD, netG, device, train_dl, val_dl, lr_D=0.0002, lr_G=0.0002, resample=True,
            ...
            for i, (x, y) in enumerate(tqdm(self.train_dl)):
                ...
                if (i % self.image_interval == 0):
                    if (self.special == 'Colorization'):
                        sample_images_list = get_sample_images_list1('Pix2pix_Colorization',
                        ...
                        sample_images_list = get_sample_images_list1('Pix2pix_Normal',
                                                                    (self.val_dl, self.netG, self.device))
